...
exports.videoIndexUpdate = function (tableService, sourceFile, basePath, pathType, processRequest, processResponse, path, response, domain, settings, useCloudData, configName) {
