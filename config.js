...
exports.config = {
	"PREVIEW": {
		...
		endpoint: {
            ...
            "video.sneakerz.com": { subDomain: "preview", port: 80, auth: "none", type: "API", default: "" }
		},
		redirect: {
		}
	},
	...
	"AZURE": {
		...
		endpoint: {
			...
			"buildinthecloud.com": { subDomain: "api", port: 80, auth: "none", type: "DHTMLPlus", default: "home.htm" },
			"dhtmlplus.com": { subDomain: "api", port: 80, auth: "none", type: "DHTMLPlus", default: "home.htm" },
			"meshdaddy.com": { subDomain: "api", port: 80, auth: "none", type: "DHTMLPlus", default: "home.htm" },
			"mevirtually.com": { subDomain: "api", port: 80, auth: "none", type: "DHTMLPlus", default: "home.htm" },
			"myiot.ninja": { subDomain: "api", port: 80, auth: "none", type: "DHTMLPlus", default: "home.htm" },
			"ta5k.com": { subDomain: "api", port: 80, auth: "none", type: "DHTMLPlus", default: "home.htm" },
			"webtavern.net": { subDomain: "api", port: 80, auth: "none", type: "DHTMLPlus", default: "home.htm" }
		},
		redirect: {
		}
	}
